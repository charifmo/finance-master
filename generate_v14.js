...
• category "actif" : action "modify" pour tout actif patrimonial (productif OU foncier — source unique v17). Fournir "target" = nom de l actif. Pour un actif productif : "amount" = NOUVELLE VALEUR TOTALE (remplace). Champs optionnels dette/levier : "taux_credit", "annees_total", "annees_restantes", "apport_personnel" (mise de fonds initiale en DH), "montant_credit" (capital emprunté en DH). Ces champs ne sont mis à jour que si fournis. Pour un actif foncier : "sub_target" = scénario parmi 'conservateur' | 'pessimiste' | 'optimiste' et "amount" = NOUVELLE VALORISATION. Si "sub_target" fourni, seul le scénario est mis à jour (conservateur→value, pessimiste→val_pessimiste, optimiste→val_optimiste). Exemple actif productif : { action:"modify", category:"actif", target:"Studio Airbnb", amount:500000, apport_personnel:150000, montant_credit:350000 }. Exemple foncier : { action:"modify", category:"actif", target:"Foncier Nord", sub_target:"optimiste", amount:90000000 }.`;
...
APRÈS AVOIR INVOQUÉ UN OUTIL (web_search, propose_changes, finance_rag, committer, memory_writer), TU DOIS OBLIGATOIREMENT RÉDIGER UNE RÉPONSE TEXTUELLE DÉTAILLÉE POUR L UTILISATEUR. RÉSUME CE QUE TU AS TROUVÉ OU MODIFIÉ EN HTML BRUT. NE RENVOIE JAMAIS UNE RÉPONSE VIDE NI UN SIMPLE TOOL CALL SANS EXPLICATION. SI L OUTIL A ÉCHOUÉ, EXPLIQUE L ÉCHEC ET PROPOSE UNE ACTION ALTERNATIVE.`;
